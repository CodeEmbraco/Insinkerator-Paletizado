...
function DropdownProfile({ align }) {
  ...
  return (
    <>
      <div className="relative inline-flex bg-black">
        {/* <button
          ref={trigger}
        ...
        > */}
          ...
          <img
          className='w-8 h-8 rounded-full bg-hoverTextSidebar'
          src={icons.defaultProfile}
          width='12'
          height='12'
          alt='User'
        />
        ...
        >
          ...
          >
            <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200 text-start">
